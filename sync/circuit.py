...
@qml.qnode(dev)
def u3cry_pennylane(num_qubits: int, num_layers: int, thetas: qiskit.circuit.ParameterVector, active_blocks: np.ndarray) -> tuple[qiskit.QuantumCircuit, np.ndarray]:
    """_summary_
